...
```
# Output:
![alt text](<Screenshot 2026-03-24 214432.png>)
# Result: 
...
```
# Output:
![alt text](<Screenshot 2026-03-24 214636.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
...
```
# Output:
![alt text](<Screenshot 2026-03-24 215004.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
...
```
# Output:
![alt text](<Screenshot 2026-03-24 215237.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
...
```
# Output:
![alt text](<Screenshot 2026-03-24 215406.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
